...
public abstract class Block {
    ...
    public void setStructure(Structure structure) {
        ...
        GameLogger.log("Structure " + (structure != null ?
                structure.getClass().getSimpleName() : "None") + " set on block (" + row + "," + col + ").");
    }

    public void setUnit(Unit unit) {
        this.unit = unit;
        GameLogger.log("Unit " + (unit != null ?
                unit.getClass().getSimpleName() : "None") + " set on block (" + row + "," + col + ").");
    }
